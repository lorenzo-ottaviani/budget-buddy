...
<img src="./assets/images/app_view.png" alt="A view of the transaction frame.">
...
1. Clone this repository: **`git clone https://github.com/lorenzo-ottaviani/budget_buddy`**
